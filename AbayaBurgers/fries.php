...
$query = mysql_query("Select * from tbl_list where Category = 'Fries'");
?>
<!DOCTYPE html>
<html>
...
<div class="w3-top" id="top">
  <div class="w3-white w3-xlarge w3-padding-xlarge" style="max-width:1300px;margin:auto">
    <div class="w3-opennav w3-left w3-hover-text-grey" onclick="w3_open()"><span class="glyphicon glyphicon-list-alt"></span></div>
    <div class="w3-right"> 
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
	...
	<div class = "header"> <h1 style="color:blue;"> Fries </h1> </div>
